    ...
    <div class="navbar navbar-default" id="navbar-second">
            ...
            <div class="navbar-collapse collapse" id="navbar-second-toggle">
                <ul class="nav navbar-nav navbar-nav-material">
                    ...
                    @endrole
                    @role('IP')
                    <li class="{{ request()->is('ip/permohonan') ? 'active' : '' }}"><a href="{{ route('ip.permohonan.index') }}"><i class="icon-user position-left"></i> <span> Permohonan Masuk</span></a></li>
                    @endrole
                    @role('P2')
                    <li class="{{ request()->is('p2/permohonan') ? 'active' : '' }}"><a href="{{ route('p2.permohonan.index') }}"><i class="icon-user position-left"></i> <span> Permohonan Masuk</span></a></li>
                    @endrole
                    @role('HHP')
                    <li class="{{ request()->is('hhp/permohonan') ? 'active' : '' }}"><a href="{{ route('hhp.permohonan.index') }}"><i class="icon-user position-left"></i> <span> Permohonan Masuk</span></a></li>
                    @endrole
                    <!-- /main -->
                </ul>
            </div>

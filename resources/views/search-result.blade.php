...
<div class="c-content-box c-size-md c-bg-white">
	<div class="container">
		...
		<div class="c-content-panel">
			<div class="c-label">Hasil pencarian : <b>{{ $request->nomor_pemohon }}</b> atas nama <b>{{ $request->nama }}</b></div>
			<div class="c-body">
				<div class="row">
					<div class="col-md-12">
						<table class="table">
        ...
        @else
            <div class="alert alert-danger" role="alert"><center>Oops.. Data <b>{{ $request->nomor_pemohon }}</b> atas nama <b>{{ $request->nama }}</b> Tidak Ditemukan, Kembali ke <a href="/">Home</a></center></div>
        @endif
    </div>
 </div>   
<!-- END: PAGE CONTENT -->
